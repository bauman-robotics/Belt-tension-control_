...
void loop() {
 if (mqtt_connected) {
  delay(10);  
  //zero_sensor_now = digitalRead(zero_sensor_pin);
  pin_2_now = digitalRead(ventil_2_pin);  // = 1 after reset
  //if (zero_sensor_now != zero_sensor_old) {
  //  change_state_pin_1 = 1; 
  //  zero_sensor_old = zero_sensor_now;
  //}
