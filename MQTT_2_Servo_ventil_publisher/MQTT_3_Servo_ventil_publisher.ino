...
void onMqttConnect(bool sessionPresent) {
  ...
  uint16_t packetIdSub = mqttClient.subscribe(testlol, 2);
  Serial.print(Subscribing at QoS 2, packetId );
  Serial.println(packetIdSub);
  mqttClient.publish(testlol, 0, true, test 1);
  Serial.println(Publishing at QoS 0);
  uint16_t packetIdPub1 = mqttClient.publish(testlol, 1, true, test 2);
  Serial.print(Publishing at QoS 1, packetId );
  Serial.println(packetIdPub1);
  uint16_t packetIdPub2 = mqttClient.publish(testlol, 2, true, test 3);
